                ...
                <div class="form-control w-full">
                  <label class="label cursor-pointer">
                    ...
                    <input
                      ...
                      onChange={() => setIncludeOverlapping((x) => !x)}
                      class="checkbox"
                    />
                  </label>
                </div>
            ...
            <div class="space-y-2">
              ...
              <div class="flex justify-between space-x-8">
                <select
                  ...
                  value={match1()}
                  onChange={(e) => setMatch1(e.currentTarget.value)}
                >
                ...
                <select
                  class="select select-bordered w-full max-w-xs"
                  value={match2()}
                  onChange={(e) => setMatch2(e.currentTarget.value)}
                >
                  <option disabled selected>
                    Match Column
                  </option>
